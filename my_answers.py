...
#         sig_hidden = self.activation_function(hidden_outputs)
...
#         print("finout", final_outputs.shape)
#         print("hidout", hidden_outputs.shape)
#         print("hiderr", hidden_error.shape)
#         print("sighid", sig_hidden.shape)
#         print("weight h o", delta_weights_h_o.shape)
#         print("weight i h", delta_weights_i_h.shape)
#         print("y", y.shape)
